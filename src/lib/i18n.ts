...
const copy = {
    en: {
        ...
        optionsControlsHint: 'Sound, language, and table rule settings for this device.',
        optionsStrategyHint: 'Reference moves for the current 6-deck house rules.',
        optionsSessionHint: 'Bankroll, streaks, and reset controls stored locally.',
        betting: 'Betting',
        ...
        lateSurrenderHint: 'Allow surrender on the opening hand only. Disabled by default.',
        strategyAssist: 'Strategy assist',
        strategyAssistHint: 'Show a very subtle marker on the recommended action during your turn. Disabled by default.',
        ...
        houseRulesAdvancedBody: 'Double after split, optional late surrender, resplit to four hands except aces, split aces draw one card only.',
    ...
    fr: {
        ...
        lateSurrenderHint: 'Autoriser l abandon uniquement sur la main d ouverture. Desactive par defaut.',
        strategyAssist: 'Aide strategie',
        strategyAssistHint: 'Affiche un repere sur l action conseillee pendant votre tour. Desactive par defaut.',
        ...
        houseRulesAdvancedBody: 'Double apres separation, abandon tardif optionnel, nouvelle separation jusqu a quatre mains sauf les as, les as separes recoivent une seule carte.',
...
const exactTranslations: Record<string, string> = {
    ...
    'Late surrender is disabled in table controls.': 'L abandon tardif est desactive dans les reglages de table.',
